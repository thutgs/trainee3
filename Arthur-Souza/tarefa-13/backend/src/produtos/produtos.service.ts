...
// service é o código o qual interage com o banco de dados usando o TypeORM, 
// realizando as operações de CRUD (Create, Read, Update, Delete)
...
export class ProdutosService {
  ...
  create(dto: CreateProdutoDto) {
    ...
    return this.repository.save(produto); // .save() efetivamente executa o comando SQL 'INSERT'
